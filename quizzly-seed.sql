...
VALUES (111, 'Shapes Quiz', 'A fun sample quiz about shapes!', 'testuser'),
       (222, 'States Quiz', 'A fun quiz about US states!', 'testuser2'),
       (333, 'Arithmetic Quiz', 'A sample quiz about arithmetic!', 'testuser');
